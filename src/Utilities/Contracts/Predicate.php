 ...
 * @template P of mixed
 *
 * @extends \Smpl\Utilities\Contracts\Func<P, bool>
 *
...
interface Predicate extends Func
{
     ...
     *
     * Takes an argument of type {@see \Smpl\Utilities\Contracts\Predicate}<P> and returns
     * a new {@see \Smpl\Utilities\Contracts\Predicate} that represents a short-circuiting
     ...
     *
     * Takes an argument of type {@see \Smpl\Utilities\Contracts\Predicate}<P> and returns
     * a new {@see \Smpl\Utilities\Contracts\Predicate} that represents a logical XOR of
     ...
     *
     * Takes no arguments and returns a new {@see \Smpl\Utilities\Contracts\Predicate} that
